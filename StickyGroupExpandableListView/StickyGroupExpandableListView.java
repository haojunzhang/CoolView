...
/**
 * A ListView that maintains a item_group pinned at the top of the list. The
 * pinned item_group can be pushed up and dissolved as needed.
 */
public class StickyGroupExpandableListView extends ExpandableListView {
    ...
    public interface PinnedHeaderAdapter {
        ...
        /**
         * Pinned item_group state: don't show the item_group.
         */
        int PINNED_HEADER_GONE = 0;

        /**
         * Pinned item_group state: show the item_group at the top of the list.
         */
        int PINNED_HEADER_VISIBLE = 1;

        /**
         * Pinned item_group state: show the item_group. If the item_group extends beyond
         * the bottom of the first shown element, push it up and clip.
         */
        int PINNED_HEADER_PUSHED_UP = 2;

        /**
         * Configures the pinned item_group view to match the first visible list item.
         *
         * @param header   pinned item_group view.
         * @param position position of the first visible list item.
         * @param alpha    fading of the item_group view, between 0 and 255.
         */
    ...
    public StickyGroupExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public StickyGroupExpandableListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public void setPinnedHeaderView(View view) {
        mHeaderView = view;
        Log.d("===", mHeaderView != null ? "Y" : "N");
        // Disable vertical fading when the pinned item_group is present
